...
// When joe.scope() is invoked, "this" is calling the joe array.
// 2. What is "this" when joe.scopeArrow() is invoked?
// When joe.scope() is invoked, "this" is calling the array for Window, which I am assuming means that it's calling everything.
// 3. Explain why "this" is different when an arrow function is used.
// I believe the reason why "this" is different when the arrow function is used is because "this" isn't being assigned to an array.
