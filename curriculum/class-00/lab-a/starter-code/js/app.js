...
function displayPics(){
  ...
  // The reason that the console log threw up an error message is because changing the variable declaration changed the scope of the rando variable resulting in the console log being out of range of the variable scope.
  console.log(viewed);
